...
class AUASACAgent(Agent):
    ...
    def __init__(self, obs_dim, action_dim, action_range, device, critic_cfg,
        ...
        self.actor_old = hydra.utils.instantiate(actor_cfg).to(self.device)
        ...
        self.actor_old_optimizer = torch.optim.Adam(self.actor_old.parameters(), lr=actor_lr, betas=actor_betas)
